    ...
    def __init__(self, config, fc_layers):
        ...
        with tf.name_scope('RNN-Layer'):
            ...
            if self.bi:
                ...
                output, _ = tf.nn.bidirectional_dynamic_rnn(cell, cell2, rnn_x, initial_state_fw=init_state_fw, initial_state_bw=init_state_bw, time_major=False)
        ...
        grad = [    # Gradient Clipping
            None if g is None else tf.clip_by_norm(g, 4.0)
            for g in grad
        ]
